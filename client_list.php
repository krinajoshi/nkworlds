...
<html>
<head>
<title>Client List|N.K. Worlds </title>
...
?>                                                      
                ...
                <div class="site">
                    ...
                    <div class="con_head">
                            <h2 class="title costom">Client list</h2>
                     </div>
                    ...
                    <div class="container">
                        <div class="col-md-12 content_head">
                            ...
                            <h2 style="padding-bottom: 20px;text-align: left;" class="tittle c"><b> Our Clients</b></h2>
                            <div class="sapator"></div>
                            <h5 style="padding-bottom: 20px;text-align: left;font-size: 16px" class="tittle c"><b> N.K. Worlds has created a unique place in the industry since its incorporation. It has the large customer group all over the world. </b></h5>
                            
                            <h4 style="padding-bottom: 20px;
    text-align: left;
    text-decoration: underline;" class="tittle c">N.K. Worlds is supplying it's qualitative products to the following Industries. </h4>
