...
<ul class="unlist">
<li>N.K. Fasteners is a wing of N.K. Group of Industries and has created a unique place in the world of fasteners within a very short time.  The N.K. Group of Industries is an emerging and developing group of companies from India with new creativities and Innovations. </li>
                                    <li>With a vision to be a largest group with diversified portfolio the N.K. group of Industries has been established by its’ Promoter & Founder Mr. NITISH KARIYA. </li>
                                    <li>We are the Group of companies not bounded by any product range or Industry but bounded by the capabilities. We are committed to the customer for giving the best and qualitative product range and services they require. Our main motive is to have the mutual benefits where priority is to satisfy the customer with the Quality services. </li>
                               
                                    <li>N.K. Fasteners is one of the prominent manufacturer, supplier and exporter of the fasteners in many Industries in India and in abroad as well. </li>
                                    <li>Backed by profound experience of the varied Pros and Cons of the market, we have been enabled our self to offer a wide range of fasteners in different Sizes, Material and Quality required by customer. </li>			
 </ul>
